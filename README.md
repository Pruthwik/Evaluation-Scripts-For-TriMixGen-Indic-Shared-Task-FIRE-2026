...
- The scoring for subtask A uses multiple transformer models and multiple evalation metrics. The submissions for subtask A will take upto 24 hours to get reflected on the leaderboard. The scoring for subtask B uses the macro F1-score metric and the submissions will be reflected on the leaderboard instantly.
